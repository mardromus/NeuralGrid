import { A as AptosConfig, s as AccountAddressInput, b3 as InputGenerateTransactionOptions, c5 as PaginationArgs, c8 as OrderByArg, c9 as WhereArg, t as AccountAddress, az as SimpleTransaction, b9 as InputEntryFunctionData } from '../account-CcxnCdYZ.mjs';
import { CurrentAptosNamesBoolExp } from '../types/generated/types.mjs';
import { AnsName, RawANSName, ExpirationStatus } from '../types/ans.mjs';
 ...
 * @group Implementation
 */
declare function getANSExpirationStatus({ aptosConfig, name, gracePeriod, }: {
    name: RawANSName;
 ...
 * @group Implementation
 */
declare function registerName(args: RegisterNameParameters): Promise<{
 ...
 * @group Implementation
 */
declare function clearTargetAddress(args: {
    aptosConfig: AptosConfig;
    sender: AccountAddressInput;
    name: string;
    options?: InputGenerateTransactionOptions;
 ...
 * @group Implementation
 */
declare function getANSGracePeriod(args: {
    aptosConfig: AptosConfig;
}): Promise<number>;
/**
